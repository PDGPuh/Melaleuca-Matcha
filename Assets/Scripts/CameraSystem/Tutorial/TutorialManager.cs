    ...
    public class TutorialManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            switch (currentLesson)
            {
                ...
                case LessonStep.ManualFocus:
                    if (CameraManager.Instance != null && CameraManager.Instance.FocusSys.ActiveFocusMode == FocusMode.Manual)
                    {
                        isWaitingForAction = false;
                ...
                case LessonStep.ChangeExposure:
                    if (CameraManager.Instance != null && CameraManager.Instance.ExpSys.ISO != 200)
                    {
                        isWaitingForAction = false;
        ...
        private IEnumerator BurstLessonRoutine()
        {
            ...
            string[] lines = new string[]
            {
                ...
                "Đặc biệt con có thể nhấn Giữ Chuột Trái để chụp liên tục (Burst Mode 5 FPS) bắt trọn mọi khoảnh khắc chuyển động của thú rừng.",
